import { CardData, WorldQuery, CardActionData } from "../../data-format-description";
...
const arrayOfLength = (count: number): unknown[] => Array.apply(null, Array(numberOfCards));
...
export const cards: CardData[] = arrayOfLength(numberOfCards).map<CardData>((_, index) => {
